...
import com.android.tine.utils.ReflectionHelper;

/**
 * @author canyie
 */
public class HookReplacementPrimitiveTest extends Test {
    private static Tine.HookRecord hookRecord;
    ...
    @Override public int run() {
        if (hookRecord == null) {
            ...
            hookRecord = new Tine.HookRecord(target, Tine.getArtMethod(target));
            Tine.hookReplace(hookRecord, hook, backup, true);
        }
        return testImpl();
    }
