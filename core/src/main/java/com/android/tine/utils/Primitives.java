package com.android.tine.utils;
...
@SuppressWarnings("JavaReflectionMemberAccess") @SuppressLint("PrivateApi") public final class Primitives {
    private static final String TAG = "Tine.Primitives";
    ...
    public static long getAddress(Object o) {
        if (o == null) return 0;
        long address = Tine.getAddress(currentArtThread(), o);
        if (address == 0) {
