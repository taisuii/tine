...
public final class Arm64Entry {
    ...
    private static Object handleBridge(long artMethod, long originExtras, long sp,
        ...
        long extras = Tine.cloneExtras(originExtras);
            ...
            for (int i = 0; i < hookRecord.paramNumber; i++) {
                ...
                if (paramType == double.class) {
                    ...
                    if (paramType.isPrimitive()) {
                        ...
                        value = Tine.getObject(thread, asLong & INT_BITS);
                    }
                }
                args[i] = value;
                stackIndex++;
    ...
    private static ThreeTuple<long[], long[], double[]> getArgs(Tine.HookRecord hookRecord, long extras, long sp,
        ...
        Tine.getArgsArm64(extras, sp, typeWides, coreRegisters, stack, fpRegisters);

        do {
            // x1-x3 are restored in Tine.getArgs64
            if (crLength < 4) break;
            coreRegisters[3] = x4;
            if (crLength == 4) break;
            coreRegisters[4] = x5;
