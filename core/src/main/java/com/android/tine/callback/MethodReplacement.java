 ...
 * @author canyie
 * @see MethodHook
 * @see Tine#hook(java.lang.reflect.Member, MethodHook) 
 */
public abstract class MethodReplacement extends MethodHook {
    ...
    public static final MethodReplacement DO_NOTHING = new MethodReplacement() {
        @Override protected Object replaceCall(Tine.CallFrame callFrame) {
            return null;
        }
    };
     ...
     */
    protected abstract Object replaceCall(Tine.CallFrame callFrame) throws Throwable;

    @Override public final void beforeCall(Tine.CallFrame callFrame) {
        try {
    ...
    @Override public final void afterCall(Tine.CallFrame callFrame) {
    }
     ...
     * @return An instance that can be used for {@link Tine#hook(Member, MethodHook)}
     */
