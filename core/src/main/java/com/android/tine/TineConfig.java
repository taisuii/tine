 ...
 * @author canyie
 */
@SuppressWarnings("WeakerAccess") public final class TineConfig {
    ...
    /**
     * Whether all Tine hooks won't take effect.
     */
